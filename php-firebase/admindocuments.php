                            ...
                            <form action="actioncode.php" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group input-group">
                                    ...
                                    <select class="form-control" name="document_type" id="document_type" required="" onchange='toggleDropdown(this);'>
                                            ...
                                            <select class="form-control permitcertificatetype" name="permitcertificate_type" id="businesspermit_type" style="display:none;" onchange = 'otherToggle(this)'>
                                            ...
                                            <select class="form-control permitcertificatetype" name="permitcertificate_type" id="barangaypermit_type" style="display:none;">
                                            ...
                                            <select class="form-control permitcertificatetype" name="permitcertificate_type" id="barangaycertificate_type" style="display:none;">
                                    ...
                                    <div class="form-group input-group">
                                        ...
                                        <select class="form-control" name="status" id="documentstatus" required="">
