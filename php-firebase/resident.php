                                ...
                                <form action="actioncode.php" method = "POST">
                                  ...
                                  <fieldset>
                                    ...
                                    <div  class="personal-details">
                                      ...
                                      <div>
                                      <div><label>Contact Number</label><input name="contactnum" class="form-control"  placeholder="" type="text" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" pattern="[0-9]{10}" required=""></div>
                                        <div><label>Nationality</label><input type="text" class="form-control" name="nationality"></div>
                                        <div><label>House Number</label><input type="text" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" class="form-control" name="houseno"></div>
                                        <div><label>Street</label><input type="text" class="form-control" name="street"></div>
                                        <div><label>Barangay</label><input type="text" class="form-control" name="barangay"></div>
                                        <div><label>City</label><input type="text" class="form-control" name="city"></div>
                                        <div><label>Province</label><input type="text" class="form-control" name="province"></div>
                                        <div><label>ZIP Code</label><input name="zipcode" class="form-control"  type="text" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" pattern="[0-9]{4}" required=""></div>
                                  ...
                                  <button class="submitbtn" name="addres" type="submit">Submit</button>
                                </form>
                                </div> 
                                <?php
